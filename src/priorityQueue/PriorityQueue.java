...
public class PriorityQueue {
    ...
    /**
     * Parcoure la file, si le sommet existe alors on modifie le parent et le coût uniquement si le coût qu'on souhaite inséré est inférieur à la valeur déja stockée, si la valeur existe pas alors on l'insère
     * @param val valeur à ajouter
     */
